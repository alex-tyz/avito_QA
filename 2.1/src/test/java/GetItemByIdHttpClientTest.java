...
public class GetItemByIdHttpClientTest {
    ...
    public void testGetItemById() throws Exception {
        ...
        HttpRequest getRequest = HttpRequest.newBuilder()
                .uri(URI.create(BASE_URL + "/api/1/item/" + itemId))
        ...
        JsonObject retrievedItem = jsonArray.get(0).getAsJsonObject();
        assertEquals(itemId, retrievedItem.get("id").getAsString());
        assertNotNull(retrievedItem.get("name"));
    }
}